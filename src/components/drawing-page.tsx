                    ...
                    {showControls && (
                      <div className="relative">
                        <input
                          ...
                          className="w-64 pl-4 pr-12 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm text-sm transition-all"
                        />
                        <div className="absolute right-4 top-0 bottom-0 flex items-center justify-center text-gray-400 pointer-events-none">
